    ...
    <main className="min-h-screen flex items-center justify-center px-5">
      ...
      >
        <div className="text-center space-y-1">
          ...
          <h1 className="text-xl font-black text-amber-50">Create your account</h1>
          <p className="text-xs text-amber-300/50">Save your progress and track your streak</p>
        </div>
        ...
        <p className="text-center text-xs text-amber-300/40">
          ...
          <Link href="/signin" className="text-amber-400/70 hover:text-amber-300 transition">
            Sign in
          </Link>
        </p>
      </div>
