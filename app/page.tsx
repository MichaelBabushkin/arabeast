        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <Link
              ...
              className="group relative flex flex-col gap-3 rounded-3xl p-5 transition hover:scale-[1.02]"
              style={{
                background: "linear-gradient(135deg, rgba(167,139,250,0.16) 0%, rgba(76,40,130,0.10) 100%)",
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs font-black px-2.5 py-0.5 rounded-full text-violet-950" style={{ background: "#c4b5fd" }}>
                  WORDS
                </span>
              </div>
              <div>
                <h2 className="text-lg font-bold text-amber-50">My Vocabulary</h2>
                <p className="text-sm text-amber-200/55 mt-0.5 leading-snug">
                  Every word you meet, saved automatically. Track your progress and review with spaced repetition.
                </p>
              </div>
              <div className="flex items-center gap-1.5 text-xs text-violet-300/60 font-medium">
                <span>Auto-collected · review &amp; track</span>
                <ChevronRight className="h-3.5 w-3.5 group-hover:translate-x-0.5 transition-transform" />
              </div>
            </Link>
          </div>
